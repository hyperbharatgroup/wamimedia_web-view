...
class _CreateAccountScreenState extends State<CreateAccountScreen> {
  // 1. Create the Text Editing Controllers
  final TextEditingController _nameController = TextEditingController();
  final TextEditingController _contactController = TextEditingController();

  bool _isAgreed = false;
  // 2. Add a state variable to track which mode is active
  bool _isEmailMode = false;

  @override
  void dispose() {
    // 3. Dispose of the controllers when the screen is closed to prevent memory leaks
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // 4. Make the Contact Field dynamic based on _isEmailMode
                  _buildCustomTextField(
                    controller: _contactController, // Pass the controller
                  ...
                  // 5. Dynamic Toggle Button
                  Row(
                    children: [
                      Expanded(
                        child: OutlinedButton.icon(
                          onPressed: () {
                            // Toggle the mode and clear the input field
                            setState(() {
                  ...
                  ElevatedButton(
                    onPressed: () {
                      // 6. Access the values using the controllers
                      String name = _nameController.text;
                      String contactInfo = _contactController.text;

                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Name: $name | Contact: $contactInfo')),
                      );
                    },
  ...
  // Updated helper widget to accept TextEditingController and KeyboardType
  Widget _buildCustomTextField({
    ...
    return TextFormField(
      ...
      keyboardType: keyboardType, // Helps show the correct keyboard (numbers vs emails)
